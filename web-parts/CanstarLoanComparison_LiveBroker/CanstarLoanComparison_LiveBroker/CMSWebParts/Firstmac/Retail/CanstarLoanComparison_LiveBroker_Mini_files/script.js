        ...
        success: function (data, self) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                */
                ...
                if (comparisonRate == undefined || isNaN(comparisonRate) || comparisonRate == "") {
                    //console.log(data[i].NAME + " - " + data[i].ID);
                }

                if (lenderName.toLowerCase() != "anz" && lenderName.toLowerCase() != "commonwealth bank" && lenderName.toLowerCase() != "firstmac" && lenderName.toLowerCase() != "suncorp bank" && lenderName.toLowerCase() != "westpac") {
                    canShowRecord = false;
                }
